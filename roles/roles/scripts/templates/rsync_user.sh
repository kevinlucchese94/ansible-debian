...
remote_base="/home/{{ nome }}/foto_e_video"
...
if grep -qs "$remote_base" /proc/mounts; then
  ...
  # RSYNC DEI VIDEO
  perform_rsync_video "$remote_base/ALL/" "/home/{{ nome }}/Video"

  # RSYNC DELLE FOTO
  perform_rsync_foto "$remote_base/ALL/" "/home/{{ nome }}/Foto"
else
  # monta il disco samba sulla cartella specificata
  sudo mount -t cifs -o username=pi,password=Erminio67,rw //192.168.5.198/foto_e_video /home/{{ nome }}/foto_e_video
